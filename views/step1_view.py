    ...
    <table class="safety-stock-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="formula-cell"><strong>LT間差分（実績−平均）＝ LT期間の実績合計 − LT期間実績合計の平均</strong><br>→ 欠品許容率 p（例：1%）をカバーする水準を採用<br>※ 総件数 ＝ 全期間の日数 − リードタイム LT ＋ 1</td>
            ...
            <tr>
                ...
                <td class="formula-cell"><strong>LT間差分（実績−計画） ＝ LT期間の実績合計 − LT期間の計画合計</strong><br>→ 欠品許容率 p（例：1%）をカバーする水準を採用<br>※ 総件数 ＝ 全期間の日数 − リードタイム LT ＋ 1</td>
